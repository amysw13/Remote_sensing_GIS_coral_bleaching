...
HINT: Do a sanity check to make sure your data set does not include impossible values. For example, apply the function “summary” to your data. Calculation of annualized anomalies commands for the calculation of annualized anomalies are provided in “Bleaching_analysis.R”.
