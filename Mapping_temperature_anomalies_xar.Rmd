...
Load required packages
 ...
 - Below is an example code which is useful when sharing code
...
## Function to load GIOVANNI files
...
Original GIOVANNA file names are extremely long. 
...
# Calculating temeperature anomalies 
...
```{r Unedited map, fig.height=5, fig.width=10}
print(p_map)
```
...
```{r}
write.csv(anomaly, file = "./Output/long_term_anomaly.csv")
```
